                    ...
                    <table  style={{textAlign:"center",width:"100%"}} cellPadding="5" cellSpacing="0" className="toplink">
                        ...
                        <tr>
                            <td width="46%" className="pageContent">
                                <div style={{textAlign:"left"}} className="copyright">Copyright@2010, Allrights reserved Mithra</div>
                            </td>
                            <td width="54%" className="pageContent">
                                <div style={{textAlign:"right"}} className="copyright">Web Designed and Maintained by ideaworx</div>
                            </td>
                        </tr>
                    </table>
                </td>
